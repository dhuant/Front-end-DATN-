            ...
            <div className="properties-detail-slider simple-slider mb-40">
              ...
              >
                ...
                <ol className="carousel-indicators thumbs visible-lg visible-md">
                  ...
                  >
                    <img
                      src="/img/properties/properties-small-1.jpg"
                      alt="Chevrolet Impala"
                    />
                  </li>
                  <li
                    ...
                    <div className="comment">
                      ...
                      <div className="comment-content">
                        <div className="comment-meta">
                          <div className="comment-meta-author">Jane Doe</div>
                        ...
                        <div className="comment-body">
                          ...
                          <p>
                            ...
                            dapibus tempus nulla. Donec vel nulla dui.
                            Pellentesque sed ante sed ligula hendrerit
                            condimentum. Suspendisse rhoncus fringilla ipsum
                            quis porta.
                          </p>
                        </div>
                      </div>
                          ...
                          <div className="comment-content">
                            ...
                            <div className="comment-body">
                              ...
                              <p>
                                ...
                                adipiscing elit. Donec luctus tincidunt aliquam.
                                Aliquam gravida massa at sem vulputate interdum
                                et vel eros. Maecenas eros enim, tincidunt vel
                                turpis vel, dapibus tempus nulla. Donec vel
                                nulla dui.
                              </p>
                            </div>
                          </div>
